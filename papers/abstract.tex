...
\name{Alex Rudnick, Taylor Skidmore, Michael Gasser}

\address{Indiana University, School of Informatics and Computing \\
               Bloomington, IN, USA\\
               {\tt \{alexr,taylskid,gasser\}@indiana.edu}}

%% \abstract{Each article must include an abstract of 150 to 200 words in Times
%9
...
%% [something about evaluation or the lack thereof ??]
